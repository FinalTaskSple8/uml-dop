...
import SIPH.payment.PaymentDecorator;
...
public class PaymentDecorator extends PaymentDecorator{
    ...
    public IPayment createIPayment(Map<String, Object> requestBody){
		...
		IPayment IPayment = IPaymentFactory.createIPayment(
			"SIPH.payment.core.PaymentDecorator",
		);
    ...
    public IPayment createIPayment(Map<String, Object> requestBody, int id){
		...
		IPayment ipayment = IPaymentFactory.createIPayment("SIPH.payment.core.PaymentDecorator", );
		return ipayment;
	}
