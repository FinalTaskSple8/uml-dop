...
public abstract class SearchServiceComponent implements Service{
	protected RepositoryUtil<> Repository;

    public SearchServiceComponent(){
        this.Repository = new RepositoryUtil<>(SIPH.search.core.SearchComponent.class);
    }	
